...
var total = 0;
// Loop through the outer array finances = [[innerArray1],[innerArray2]...]
for (var i = 0; i < finances.length; i++) {
  const innerArray = finances[i];
  //console.log(innerArray);

  //loop through the innner array
  for (var j = 0; j < innerArray.length; j++) {
    //console.log(innerArray[j]);
    if (typeof innerArray[j] === "number") {
      total = total + innerArray[j];
    }
  }
}
